...
namespace ShaderTest
{
    public class ShaderTestGame : Game
    {
        ...
        {  
            ...
            if (keyboardState.IsKeyDown(Keys.Space) && spaceUpLast)
                technique = ++technique % 4;
            spaceUpLast = keyboardState.IsKeyUp(Keys.Space);
        ...
        private void DrawText()
        {
            ...
            text += "Arrow Up/Down to change Tesselation: \n";
            text += "Arrow Left/Right to change GeometryGeneration: \n";
